...
player = (randrange(x-1), randrange(y-1))
score = 1
restart = False
walk_reward = -0.04

walls1 = [(1, 1), (1, 2), (2, 1), (2, 2)]
walls2 = [(6, 1), (6, 2), (7, 1), (7, 2)]
walls3 = [(3, 5), (3, 6), (3, 7), (4, 5), (4, 6), (4,7) , (5, 5), (5, 6), (5,7)]
...
def try_move(dx, dy):
    ...
    new_y = player[1] + dy
    score += walk_reward
    if (((new_x >= 0) and (new_x < x) and (new_y >= 0) and (new_y < y) and not ((new_x, new_y) in walls1) and (new_x >= 0) and (new_x < x) and (new_y >= 0) and (new_y < y) and not ((new_x, new_y) in walls2)and (new_x >= 0) and (new_x < x) and (new_y >= 0) and (new_y < y) and not ((new_x, new_y) in walls3))):
